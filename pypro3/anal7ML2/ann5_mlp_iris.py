...
# model = xgb.XGBClassifier(boost='gbtree', n_estimator=500, random_state = 1)

# from sklearn import svm
# # model = svm.SVC(C = 1)
# model = svm.LinearSVC(C = 100)  # 속다가 향상 된다 
...
print()
print('분류 정확도 확인 1 ')
print('%.3f'% accuracy_score(y_test, y_pred))   # 0.978
print('분류 정확도 확인 2 ')                        # 0.9777777
