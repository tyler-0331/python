...
print(result_cut)   # [(9, 11], (3, 7], (7, 9], (3, 7]]   (a,b] <== a < x <=b; a초과 b이하
...
print(pd.merge(df1,df3, left_on='key', right_on='key2'))  # right outer join
...
print('DataFrame관련 집계 메소드: pivot,groupby,pivot_table --------------')
...
print(df.pivot_table(index = ['city','year'],aggfunc=[len,np.sum])) # city 별 year 별 그룹화 그리고 value 들은 그것 들 의 sum 
