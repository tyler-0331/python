...
print(data.head(3))
print(data.tail(3))
print(data['education'].unique())  # [1 2 3]   # 교육 수준 (독립변수)  - 범주형
...
# ctab = pd.crosstab(index = data['education'], columns = data['smoking'], normalize= True) #비
...
# 해석: p:0.0011800326671 < 0.05 이므로 귀무 기각.
